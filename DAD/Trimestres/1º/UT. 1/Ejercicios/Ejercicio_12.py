# Ejercicio 12: "Programa en Python una función que solucione una ecuación de segundo grado. Muestra sus dos soluciones o muestra que no tiene solución en los números reales (R)."
...
nombre = input("Bienvenido al programa 'Calculadora de ecuaciones de segundo grado', por favor ingrese su nombre: ")
