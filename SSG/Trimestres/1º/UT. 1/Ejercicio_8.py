# Ejercicio 8: "Pedir al suario que introduzca un array por consola para luego ser impreso de a uno sus elementos. Y después haz que la consola pregunte al usuario por un elemento concreto y luego lo imprima."
