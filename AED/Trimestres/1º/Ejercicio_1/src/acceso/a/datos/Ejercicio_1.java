...
public class Ejercicio_1 {
    public static void main(String[] args){
        ...
        //nombreArchivo = "C:\\Users\\Alumno\\Documents\\2Âº CFGS";
        ...
        if (!file.exists()){
            ...
            if (file.isDirectory()){
                ...
                // Caso para directorios no vací­os.
                if (files != null){
                ...
                // Muestreo del resultado final.
                System.out.println("\n\tEl directorio en cuestión está o se encuentra vací­o.");
                }
            ...
            // Caso para archivos.
                ...
                if (tamañoBytes >= 0){
                    ...
                    System.out.println("\n\tEl archivo en cuestión está o se encuentra vací­o.");
                }
            }
        }
    }
